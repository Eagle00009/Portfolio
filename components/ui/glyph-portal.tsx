  ...
  return (
    <section ref={sectionRef} id={uid} className={className} aria-label={text}
      ...
      <style>{`
        ...
        ${q} [data-gp-art]{position:absolute;inset:0;width:100%;height:100%;overflow:hidden;pointer-events:none;}
      ...
      <div data-gp-pin>
        ...
        <div data-gp-caption>
          ...
          <a data-gp-enter href={`#${uid}-content`} onClick={(event) => {
            event.preventDefault();
            if (sectionRef.current) sectionRef.current.dataset.gpSkip = 'true';
